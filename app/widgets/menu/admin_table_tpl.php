...
if (!$parent) {
    $delete = '<a class="btn btn-danger btn-sm delete" onclick="return confirm(\'Silmək istədiyinizdən əminsinizmi?\');" href="' . ADMIN . '/category/delete?id=' . $id . '"><i class="far fa-trash-alt"></i></a>';
} else {
    $delete = '';
}
